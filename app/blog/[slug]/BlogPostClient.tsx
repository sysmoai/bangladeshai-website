      ...
      <section className="bg-primary-navy text-white py-14 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-4">
            <span className="text-xs font-semibold bg-primary-blue px-3 py-1 rounded-full">{post.category}</span>
      ...
      <section className="bg-bg-surface py-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-border-color">
            <Link href="/blog" className="inline-flex items-center gap-2 text-primary-blue font-semibold hover:underline">
              <ArrowLeft size={16} /> All Blog Posts
            </Link>
          </div>
        </div>
      </section>
